# Process of Design Notes

## setting:
- bunker

## bunker layout (these could be twine passages): 
- bedroom
- kitchen
- shower
- data collection room

## premise: sleep experiments for lucid dream communications

## player character:
- urbex spelunker everyman
...
- daily journals 
- dream diary 
- sleep diary (different to dream diary on wikipedia, more scientific) 
- reaction logs written by scientists 
- doctors notes and medical records 
- ethics waiver document 
- student notes 
- Textbooks 
- bookshelf book titles (personalise a person who is absent) 
- experiment outline 
- hypothesis docs 
- whiteboards 
- written notes for keeping score of card game wins for two people
- glossary
- index of terminology (ie reruns vs false awakenings)

# Research links

https://itch.io/jam/twine-only-a-story-in-mail
...
https://en.wikipedia.org/wiki/List_of_dream_diaries
...
https://pmc.ncbi.nlm.nih.gov/articles/PMC10115684/
...
https://en.wikipedia.org/wiki/Lucid_dream#Common_induction_techniques
